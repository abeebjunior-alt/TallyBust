...
function TallyBust({ userId, userEmail, initialActiveStaff }) {
  ...
  const addNewFromMissedCode = () => {
    setScanOpen(false);
    // The scanned manufacturer code was going nowhere \u2014 AddProductModal
    // already has an initialSku prop built specifically for this (it even
    // shows "Scanned code X didn't match anything yet" once it has one),
    // but nothing was ever passing the code into it, so the SKU field
    // opened blank and had to be retyped by hand every time.

...
import {
  ...
  ArrowDownCircle, ClipboardList, Plus, LogOut, Camera, List, Tag, AlertCircle, Lock, Printer, Trash2, Minus,
} from "lucide-react";
...
function ScanModal({
  ...
  saleCart, onRemoveCartItem, onUpdateCartQty, onCompleteSale,
}) {
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 6 }}>
              ...
              <button onClick={onConfirm} disabled={!qty} style={{ flex: 2, padding: "10px", borderRadius: 4, border: "none", background: qty ? T.ink : T.slateLight, color: T.cream, cursor: qty ? "pointer" : "not-allowed", fontSize: 12.5, fontWeight: 700, ...mono }}>
                {mode === "stock-in" ? "CONFIRM STOCK IN" : mode === "sale" ? "ADD TO SALE" : "CONFIRM COUNT"}
              </button>
            </div>
            {mode === "sale" && (

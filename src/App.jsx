...
function TallyBust({ userId, userEmail }) {
  ...
  const openScan = (mode) => {
    ...
    setScanCameraStage("off"); setScanSelfie(null); setScanMissCode(""); setScanCameraError("");
    setScanOpen(true);
  };
    ...
    <div style={{ ...body, background: T.ink, minHeight: "100vh", color: T.ink, display: "flex", flexDirection: "column", fontSize: 14 }}>
      ...
      {scanOpen && (
        <ScanModal mode={scanMode} setMode={setScanMode} candidates={scanCandidates} search={scanSearch} setSearch={setScanSearch}
          ...
          missCode={scanMissCode} setMissCode={setScanMissCode}
...
function ScanModal({
  ...
  cameraStage, setCameraStage, selfie, setSelfie, missCode, setMissCode, cameraError, setCameraError, onDetected, onAddNew,
}) {

...
function TallyBust({ userId, userEmail, initialActiveStaff }) {
  ...
  const openScan = (mode) => {
    ...
    setScanMode(mode);
    setScanMissCode(""); setScanCameraError(""); setScanUnitError(""); setScanLastResult(null); setScanSessionCount(0);
  ...
  const rescan = () => {
    setScanMissCode(""); setScanUnitError(""); setScanCameraError("");
    setScanCameraStage("scanning");
  };
  ...
  const switchScanMode = (newMode) => {
    ...
    setScanMode(newMode);
    setScanMissCode(""); setScanUnitError(""); setScanCameraError(""); setScanLastResult(null); setScanSessionCount(0);
    setScanCameraStage("scanning");
  };
  ...
  const handleDetectedCode = async (rawCode) => {
    ...
    if (!unit) { setScanMissCode(rawCode.trim()); setScanUnitError(""); return; }
        ...
        {missCode && (
          <div style={{ background: T.paper, borderRadius: 4, padding: "10px 12px", marginTop: 4 }}>
            <div style={{ fontSize: 12.5 }}>
              Scanned code <strong style={{ ...mono }}>{missCode}</strong> doesn't match any item's label.
            </div>
            <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
              <button onClick={onAddNew} style={{ padding: "6px 10px", borderRadius: 4, border: "none", background: T.ink, color: T.cream, cursor: "pointer", fontSize: 11.5, fontWeight: 600 }}>Register a new item</button>

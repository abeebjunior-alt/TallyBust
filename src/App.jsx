...
function TallyBust({ userId, userEmail, initialActiveStaff }) {
  ...
  // just multiplying today's price by however many are left — so a price
  // change doesn't retroactively reprice stock bought before it. Any
  // stock with no per-unit record yet (added before this tracking
  // existed) falls back to today's price.

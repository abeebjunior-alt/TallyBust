...
export default function Labels({ products, businessName, onAddProduct, onPrinted }) {
  ...
  const handlePrint = () => {
    ...
    window.print();
    // record the printed tally after the print dialog has already captured
    // the page — doing this first previously caused a background reload
    // that could reset the copy-count inputs before printing happened.

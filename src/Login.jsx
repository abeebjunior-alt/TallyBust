...
const T = { ink: "#14140F", paper: "#ECE6D6", cream: "#F6F2E8", stamp: "#A6331F", slate: "#6E6858" };
      ...
      <form onSubmit={submit} style={{ width: 320, background: T.cream, borderRadius: 6, padding: 26 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 18 }}>
          <svg width="20" height="24" viewBox="0 0 26 30">
            ...
            <line x1="2" y1="26" x2="22" y2="4" stroke={T.stamp} strokeWidth="2.6" strokeLinecap="round" />
          </svg>
        ...
        {info && <div style={{ color: "#2F6845", fontSize: 12, marginTop: 10 }}>{info}</div>}

        <button
          type="submit"
          disabled={loading}
          style={{ width: "100%", marginTop: 16, padding: "10px", borderRadius: 4, border: "none", background: T.ink, color: T.cream, fontWeight: 700, cursor: "pointer", ...mono, fontSize: 12.5 }}
        >

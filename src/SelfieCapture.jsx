...
export default function SelfieCapture({ onCapture, onCancel, T, mono, body }) {
  ...
  const capture = () => {
    ...
    // Fully release the camera — on iOS, stopping tracks alone can leave the
    // hardware "busy" for a moment, which is enough to make the next
    // (back-facing) camera request come back blank. Clearing srcObject too,
    // and pausing the element, releases it more reliably.
